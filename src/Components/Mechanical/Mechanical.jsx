...
const Mechanical = () => {
  return (
    <div className="w-full max-w-[720px] h-[450px] bg-black/[0.6] flex flex-col justify-center items-center px-5 rounded-lg">
      ...
      <div className="w-4/5 phone:px-0 tablet:px-4">
        <div className="w-full h-10 flex phone:flex-col tablet:flex-row  tablet:justify-between items-center mr-5 phone:my-3 tablet:my-0">
          <label
            htmlFor="cadcam"
            className="phone:text-xs tablet:text-lg laptop:text-xl text-white font-semibold leading-7 text-justify tracking-wide phone:mb-2 tablet:mb-0"
          >
            CAD & CAM
          </label>
          <progress
